      ...
      <section>
        <article>
          ...
          <div className="features__container container-height-1">
            ...
            <img className='features__img' src="/illustration-grow-together.svg" width="517px" height="423px" alt="grow together" />
          </div>
        ...
        <article>
          <div className="features__container features__container--reverse container-height-2">
            ...
            <img className='features__img' src="/illustration-flowing-conversation.svg" width="531px" height="378px" alt="grow together" />
          </div>
        </article>
        ...
        <article>
          ...
          <div className="features__container container-height-3">
            ...
            <img className='features__img' src="/illustration-your-users.svg" width="534px" height="404px" alt="grow together" />
          </div>
